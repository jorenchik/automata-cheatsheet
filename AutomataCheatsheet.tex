...
\begin{enumerate}
    ...
    \text{active-states did not change. Consider } \{q_3, q_5, q_8\}:
    ...
    \text{active-states did not change. Consider } \{q_2, q_4, q_7\}:
    $ ((\{q_2, q_4, q_7\}, a), \emptyset). $
    $ ((\{q_2, q_4, q_7\}, b), \{q_3, q_5, q_8\}). $
    $ ((\{q_2, q_4, q_7\}, c), \{q_2, q_7\}). $

    \text{active-states did not change. Consider } \{q_2, q_6, q_7\}:
